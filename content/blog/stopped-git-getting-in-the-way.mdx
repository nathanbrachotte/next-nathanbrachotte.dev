...
<Image
  alt={`Tree example`}
  src={`/images/blog/stopped-git-getting-in-the-way/tree.png`}
  priority
  width={672}
  height={279}
/>
...
<Image
  ...
  src={`/images/blog/stopped-git-getting-in-the-way/single_commit.png`}
  width={672}
  height={67}
/>
...
<Image
  ...
  src={`/images/blog/stopped-git-getting-in-the-way/all_fixups.png`}
  priority
  width={672}
  height={363}
/>
...
<Image
  alt={`Commits during interactive rebasing`}
  src={`/images/blog/stopped-git-getting-in-the-way/rebasing.png`}
  width={672}
  height={251}
/>

Press `enter` in VSCode, and the rebase will get you a final clean tree with one single commit ready to be pushed on your branch and merged into main.

Now imagine you want to rebase your branch onto main, but you run into conflicts. **You will only have to resolve the conflicts on your single commit and not every commit on your branch!**
