...
summary: "Just because we have to deal with 3rd party REST APIs doesn't mean we have suffer."
image: '/images/blog/typesafety-for-the-rest-of-us/cover.webp'
---

In modern web development, using <Badges.TypeScript /> efficiently is not just a luxury, it's a requirement to write reliable apps.
With well-written types come a great DX, and great DX allows for building (and maintaining) great products fast.
One main issue, though, is that often end up having to write these types, and dealing with the mental load of writing types and making them work together in addition to business logic can slow us down hard.
