...
By working on your side project first thing, you're effectively saying: _"This is what matters to me in the long run, and I'm going to give it my best energy."_

It's like [paying yourself first](https://getmoneyrich.com/pay-yourself-first/) in personal finance, but with your time and creativity.
...
As important as prioritizing for the long run is, Burkeman does provide some nuances: _don't overdo it_.
...
Instead, aim for [the Goldilocks zone](https://science.nasa.gov/resource/goldilocks-zone/). Timebox it in such a way that there's just enough time to make meaningful progress, but not so much that you dread coming back to it.
