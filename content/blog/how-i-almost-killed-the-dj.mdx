...
<Image
  alt={`Product Vision`}
  src={`/images/projects/how-i-almost-killed-the-dj/product-vision.png`}
  priority
  width={6234}
  height={4368}
/>
...
At the end of the academic year, we presented our project alongside 70 others in the [ICT Showroom](https://www.ictshowroom.fi/), a city-wide event where hundreds of students were invited to try the projects out. The jury would listen to pitches from every project the whole day. At the closing ceremony, the most ambitious, promising, and impressive projects got rewarded.
