...
Footnote: In our case we log the user agent to keep it simple

Now let's add this to our AppModule:
...
Note: [You can also exclude routes](https://docs.nestjs.com/middleware#excluding-routes) and [target specific methods](https://docs.nestjs.com/middleware#route-wildcards)
