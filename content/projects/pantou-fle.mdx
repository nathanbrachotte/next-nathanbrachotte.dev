...
The website uses Gatsby, a framework that generates pages at build time (SSG) to be blazing fast and SEO optimized. I also used Contentful as a CMS, allowing the creation and management of resources collaboratively and efficiently.
...
We're migrating all the resources to the new website and will then release it to the public.
